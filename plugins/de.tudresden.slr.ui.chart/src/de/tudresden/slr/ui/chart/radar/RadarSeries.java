...
public interface RadarSeries extends Series
{
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Line Attributes</em>' containment
	 *            reference.
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Palette Line Color</em>' attribute.
	 * @see #isSetPaletteLineColor()
	 * @see #unsetPaletteLineColor()
	 ...
	 * <!-- end-user-doc -->
	 * 
	 * @return whether the value of the '<em>Palette Line Color</em>' attribute
	 *         is set.
	 * @see #unsetPaletteLineColor()
	 * @see #isPaletteLineColor()
	 * @see #setPaletteLineColor(boolean)
	 ...
	 * <!-- end-model-doc -->
	 * 
	 * @return the value of the '<em>Background Oval Transparent</em>'
	 *         attribute.
	 ...
	 * @model unsettable="true"
	 *        dataType="org.eclipse.emf.ecore.xml.type.Boolean" required="true"
	 *        extendedMetaData="kind='element' name='BackgroundOvalTransparent'"
	 * @generated
	 */
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Background Oval Transparent</em>'
	 *            attribute.
	 * @see #isSetBackgroundOvalTransparent()
	 * @see #unsetBackgroundOvalTransparent()
	 ...
	 * Returns whether the value of the '
	 * {@link org.eclipse.birt.chart.examples.radar.model.type.RadarSeries#isBackgroundOvalTransparent
	 * <em>Background Oval Transparent</em>}' attribute is set. <!--
	...
	/**
	 * Returns the value of the '<em><b>Web Line Attributes</b></em>'
	 ...
	 * @model containment="true"
	 *        extendedMetaData="kind='element' name='WebLineAttributes'"
	 * @generated
	 */
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Web Line Attributes</em>'
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Show Web Labels</em>' attribute.
	 * @see #isSetShowWebLabels()
	 * @see #unsetShowWebLabels()
	 * @see #isShowWebLabels()
	 * @generated
	 ...
	 * end-user-doc -->
	 * 
	 * @return whether the value of the '<em>Show Web Labels</em>' attribute is
	 *         set.
	 * @see #unsetShowWebLabels()
	 * @see #isShowWebLabels()
	 * @see #setShowWebLabels(boolean)
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Show Cat Labels</em>' attribute.
	 * @see #isSetShowCatLabels()
	 * @see #unsetShowCatLabels()
	 * @see #isShowCatLabels()
	 * @generated
	 ...
	 * end-user-doc -->
	 * 
	 * @return whether the value of the '<em>Show Cat Labels</em>' attribute is
	 *         set.
	 * @see #unsetShowCatLabels()
	 * @see #isShowCatLabels()
	 * @see #setShowCatLabels(boolean)
	 ...
	 * <!-- begin-user-doc --> <!-- end-user-doc --> <!-- begin-model-doc -->
	 * 
	 * Indicates if use the series should automatically scale or use scale min
	 * max settings.
	 * 
	 * <!-- end-model-doc -->
	 * 
	 ...
	 * @model unsettable="true"
	 *        dataType="org.eclipse.emf.ecore.xml.type.Boolean" required="true"
	 *        extendedMetaData="kind='element' name='RadarAutoScale'"
	 * @generated
	 */
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Radar Auto Scale</em>' attribute.
	 * @see #isSetRadarAutoScale()
	 * @see #unsetRadarAutoScale()
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Web Label Max</em>' attribute.
	 * @see #isSetWebLabelMax()
	 * @see #unsetWebLabelMax()
	 * @see #getWebLabelMax()
	 * @generated
	 ...
	 * end-user-doc -->
	 * 
	 * @return whether the value of the '<em>Web Label Max</em>' attribute is
	 *         set.
	 * @see #unsetWebLabelMax()
	 * @see #getWebLabelMax()
	 * @see #setWebLabelMax(double)
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Web Label Min</em>' attribute.
	 * @see #isSetWebLabelMin()
	 * @see #unsetWebLabelMin()
	 * @see #getWebLabelMin()
	 * @generated
	 ...
	 * end-user-doc -->
	 * 
	 * @return whether the value of the '<em>Web Label Min</em>' attribute is
	 *         set.
	 * @see #unsetWebLabelMin()
	 * @see #getWebLabelMin()
	 * @see #setWebLabelMin(double)
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Web Label Unit</em>' attribute.
	 * @see #isSetWebLabelUnit()
	 * @see #unsetWebLabelUnit()
	 * @see #getWebLabelUnit()
	 * @generated
	 ...
	 * end-user-doc -->
	 * 
	 * @return whether the value of the '<em>Web Label Unit</em>' attribute is
	 *         set.
	 * @see #unsetWebLabelUnit()
	 * @see #getWebLabelUnit()
	 * @see #setWebLabelUnit(String)
	 ...
	 * @model unsettable="true"
	 *        dataType="org.eclipse.emf.ecore.xml.type.Boolean" required="true"
	 *        extendedMetaData="kind='element' name='FillPolys'"
	 * @generated
	 */
	boolean isFillPolys( );
	 ...
	 * Sets the value of the '
	 * {@link org.eclipse.birt.chart.examples.radar.model.type.RadarSeries#isFillPolys
	 * <em>Fill Polys</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Fill Polys</em>' attribute.
	 * @see #isSetFillPolys()
	 * @see #unsetFillPolys()
	 * @see #isFillPolys()
	 * @generated
	 ...
	 * @model unsettable="true"
	 *        dataType="org.eclipse.emf.ecore.xml.type.Boolean" required="true"
	 *        extendedMetaData="kind='element' name='ConnectEndpoints'"
	 * @generated
	 */
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Connect Endpoints</em>' attribute.
	 * @see #isSetConnectEndpoints()
	 * @see #unsetConnectEndpoints()
	 ...
	 * <!-- end-user-doc -->
	 * 
	 * @return whether the value of the '<em>Connect Endpoints</em>' attribute
	 *         is set.
	 * @see #unsetConnectEndpoints()
	 * @see #isConnectEndpoints()
	 * @see #setConnectEndpoints(boolean)
	...
	/**
	 * Returns the value of the '<em><b>Web Label</b></em>' containment
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
	 * begin-model-doc -->
	 * 
	 ...
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='WebLabel'"
	 * @generated
	 */
	Label getWebLabel( );
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Web Label</em>' containment
	 *            reference.
	 * @see #getWebLabel()
	 * @generated
	 */
	...
	/**
	 * Returns the value of the '<em><b>Cat Label</b></em>' containment
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc --> <!--
	 * begin-model-doc -->
	 * 
	 ...
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='CatLabel'"
	 * @generated
	 */
	Label getCatLabel( );
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Cat Label</em>' containment
	 *            reference.
	 * @see #getCatLabel()
	 * @generated
	 */
	 ...
	 * <!-- end-user-doc -->
	 * 
	 * @return the value of the '<em>Web Label Format Specifier</em>'
	 *         containment reference.
	 ...
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='WebLabelFormatSpecifier'"
	 * @generated
	 */
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Web Label Format Specifier</em>'
	 *            containment reference.
	 ...
	 * <!-- end-user-doc -->
	 * 
	 * @return the value of the '<em>Cat Label Format Specifier</em>'
	 *         containment reference.
	 ...
	 * @model containment="true" required="true"
	 *        extendedMetaData="kind='element' name='CatLabelFormatSpecifier'"
	 * @generated
	 */
	 ...
	 * 
	 * @param value
	 *            the new value of the '<em>Cat Label Format Specifier</em>'
	 *            containment reference.
	...
	/**
	 * Returns the value of the '<em><b>Plot Steps</b></em>' attribute. The
	 ...
	 * Sets the value of the '
	 * {@link org.eclipse.birt.chart.examples.radar.model.type.RadarSeries#getPlotSteps
	 * <em>Plot Steps</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @param value
	 *            the new value of the '<em>Plot Steps</em>' attribute.
	 * @see #isSetPlotSteps()
	 * @see #unsetPlotSteps()
	 * @see #getPlotSteps()
	 * @generated
