 ...
 * @generated
 */
public class RadarTypePackageImpl extends EPackageImpl implements
		RadarTypePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	public static RadarTypePackage init() {
		if (isInited)
			return (RadarTypePackage) EPackage.Registry.INSTANCE
					.getEPackage(RadarTypePackage.eNS_URI);

		// Obtain or create and register package
		RadarTypePackageImpl theRadarTypePackage = (RadarTypePackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof RadarTypePackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new RadarTypePackageImpl());
		...
		EPackage.Registry.INSTANCE.put(RadarTypePackage.eNS_URI,
				theRadarTypePackage);
	...
	public void createPackageContents() {
		...
		createEAttribute(radarSeriesEClass,
				RADAR_SERIES__BACKGROUND_OVAL_TRANSPARENT);
		...
		createEReference(radarSeriesEClass,
				RADAR_SERIES__WEB_LABEL_FORMAT_SPECIFIER);
		createEReference(radarSeriesEClass,
				RADAR_SERIES__CAT_LABEL_FORMAT_SPECIFIER);
	...
	public void initializePackageContents() {
		...
		initEClass(radarSeriesEClass, RadarSeries.class, "RadarSeries",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRadarSeries_Marker(),
				theAttributePackage.getMarker(), null, "marker", null, 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getRadarSeries_LineAttributes(),
				theAttributePackage.getLineAttributes(), null,
				"lineAttributes", null, 0, 1, RadarSeries.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRadarSeries_PaletteLineColor(),
				theXMLTypePackage.getBoolean(), "paletteLineColor", null, 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRadarSeries_BackgroundOvalTransparent(),
				theXMLTypePackage.getBoolean(), "backgroundOvalTransparent",
				null, 1, 1, RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getRadarSeries_WebLineAttributes(),
				theAttributePackage.getLineAttributes(), null,
				"webLineAttributes", null, 0, 1, RadarSeries.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getRadarSeries_ShowWebLabels(),
				theXMLTypePackage.getBoolean(), "showWebLabels", "false", 0, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRadarSeries_ShowCatLabels(),
				theXMLTypePackage.getBoolean(), "showCatLabels", "true", 0, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRadarSeries_RadarAutoScale(),
				theXMLTypePackage.getBoolean(), "radarAutoScale", null, 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRadarSeries_WebLabelMax(),
				theXMLTypePackage.getDouble(), "webLabelMax", "100", 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRadarSeries_WebLabelMin(),
				theXMLTypePackage.getDouble(), "webLabelMin", "0", 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRadarSeries_WebLabelUnit(),
				theXMLTypePackage.getString(), "webLabelUnit", "%", 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRadarSeries_FillPolys(),
				theXMLTypePackage.getBoolean(), "fillPolys", null, 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getRadarSeries_ConnectEndpoints(),
				theXMLTypePackage.getBoolean(), "connectEndpoints", null, 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getRadarSeries_WebLabel(),
				theComponentPackage.getLabel(), null, "webLabel", null, 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getRadarSeries_CatLabel(),
				theComponentPackage.getLabel(), null, "catLabel", null, 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getRadarSeries_WebLabelFormatSpecifier(),
				theAttributePackage.getFormatSpecifier(), null,
				"webLabelFormatSpecifier", null, 1, 1, RadarSeries.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getRadarSeries_CatLabelFormatSpecifier(),
				theAttributePackage.getFormatSpecifier(), null,
				"catLabelFormatSpecifier", null, 1, 1, RadarSeries.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE,
				!IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getRadarSeries_PlotSteps(),
				theXMLTypePackage.getInteger(), "plotSteps", "5", 1, 1,
				RadarSeries.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createExtendedMetaDataAnnotations() {
		...
		addAnnotation(radarSeriesEClass, source, new String[] { "name",
				"RadarSeries", "kind", "elementOnly" });
		addAnnotation(getRadarSeries_Marker(), source, new String[] { "kind",
				"element", "name", "Marker" });
		addAnnotation(getRadarSeries_LineAttributes(), source, new String[] {
				"kind", "element", "name", "LineAttributes" });
		addAnnotation(getRadarSeries_PaletteLineColor(), source, new String[] {
				"kind", "element", "name", "PaletteLineColor" });
		addAnnotation(getRadarSeries_BackgroundOvalTransparent(), source,
				new String[] { "kind", "element", "name",
						"BackgroundOvalTransparent" });
		addAnnotation(getRadarSeries_WebLineAttributes(), source, new String[] {
				"kind", "element", "name", "WebLineAttributes" });
		addAnnotation(getRadarSeries_ShowWebLabels(), source, new String[] {
				"kind", "element", "name", "ShowWebLabels" });
		addAnnotation(getRadarSeries_ShowCatLabels(), source, new String[] {
				"kind", "element", "name", "ShowCatLabels" });
		addAnnotation(getRadarSeries_RadarAutoScale(), source, new String[] {
				"kind", "element", "name", "RadarAutoScale" });
		addAnnotation(getRadarSeries_WebLabelMax(), source, new String[] {
				"kind", "element", "name", "WebLabelMax" });
		addAnnotation(getRadarSeries_WebLabelMin(), source, new String[] {
				"kind", "element", "name", "WebLabelMin" });
		addAnnotation(getRadarSeries_WebLabelUnit(), source, new String[] {
				"kind", "element", "name", "WebLabelUnit" });
		addAnnotation(getRadarSeries_FillPolys(), source, new String[] {
				"kind", "element", "name", "FillPolys" });
		addAnnotation(getRadarSeries_ConnectEndpoints(), source, new String[] {
				"kind", "element", "name", "ConnectEndpoints" });
		addAnnotation(getRadarSeries_WebLabel(), source, new String[] { "kind",
				"element", "name", "WebLabel" });
		addAnnotation(getRadarSeries_CatLabel(), source, new String[] { "kind",
				"element", "name", "CatLabel" });
		...
		addAnnotation(getRadarSeries_PlotSteps(), source, new String[] {
				"kind", "element", "name", "PlotSteps" });
	}
