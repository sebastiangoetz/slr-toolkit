...
public interface RadarTypePackage extends EPackage {
	 ...
	 * @generated
	 */
	RadarTypePackage eINSTANCE = de.tudresden.slr.ui.chart.radar.impl.RadarTypePackageImpl
			.init();

	/**
	 * The meta object id for the '{@link de.tudresden.slr.ui.chart.radar.impl.examples.radar.model.type.impl.RadarSeriesImpl <em>Radar Series</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see de.tudresden.slr.ui.chart.radar.impl.examples.radar.model.type.impl.RadarSeriesImpl
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link de.tudresden.slr.ui.chart.radar.impl.examples.radar.model.type.impl.RadarSeriesImpl <em>Radar Series</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see de.tudresden.slr.ui.chart.radar.impl.examples.radar.model.type.impl.RadarSeriesImpl
		 * @see org.eclipse.birt.chart.examples.radar.model.type.impl.RadarTypePackageImpl#getRadarSeries()
		 ...
		 * @generated
		 */
		EReference RADAR_SERIES__LINE_ATTRIBUTES = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__PALETTE_LINE_COLOR = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__BACKGROUND_OVAL_TRANSPARENT = eINSTANCE
		 ...
		 * @generated
		 */
		EReference RADAR_SERIES__WEB_LINE_ATTRIBUTES = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__SHOW_WEB_LABELS = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__SHOW_CAT_LABELS = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__RADAR_AUTO_SCALE = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__WEB_LABEL_MAX = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__WEB_LABEL_MIN = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__WEB_LABEL_UNIT = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__FILL_POLYS = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__CONNECT_ENDPOINTS = eINSTANCE
		 ...
		 * @generated
		 */
		EReference RADAR_SERIES__WEB_LABEL = eINSTANCE
		 ...
		 * @generated
		 */
		EReference RADAR_SERIES__CAT_LABEL = eINSTANCE
		 ...
		 * @generated
		 */
		EReference RADAR_SERIES__WEB_LABEL_FORMAT_SPECIFIER = eINSTANCE
		 ...
		 * @generated
		 */
		EReference RADAR_SERIES__CAT_LABEL_FORMAT_SPECIFIER = eINSTANCE
		 ...
		 * @generated
		 */
		EAttribute RADAR_SERIES__PLOT_STEPS = eINSTANCE
