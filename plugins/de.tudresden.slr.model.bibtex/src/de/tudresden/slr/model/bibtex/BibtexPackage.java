...
public interface BibtexPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Month</b></em>' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Doi</b></em>' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The feature id for the '<em><b>Cites</b></em>' attribute. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	...
	/**
	 * The meta object id for the
	 * '{@link de.tudresden.slr.model.bibtex.impl.BibtexFileImpl <em>File</em>}'
	 * class. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see de.tudresden.slr.model.bibtex.impl.BibtexFileImpl
	 * @see de.tudresden.slr.model.bibtex.impl.BibtexPackageImpl#getBibtexFile()
	 * @generated
	 */
	int BIBTEX_FILE = 1;
	 ...
	 * @ordered
	 */
	int BIBTEX_FILE_FEATURE_COUNT = 2;

	/**
	 * The number of operations of the '<em>File</em>' class. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	 * @generated
	 * @ordered
	 */
	int BIBTEX_FILE_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the attribute
	 * '{@link de.tudresden.slr.model.bibtex.Document#getLine <em>Line</em>}'. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the attribute '<em>Line</em>'.
	 * @see de.tudresden.slr.model.bibtex.Document#getLine()
	 * @see #getDocument()
	 * @generated
	 */
	EAttribute getDocument_Line();
	 ...
	 * '{@link de.tudresden.slr.model.bibtex.BibtexFile#getEntries
	 * <em>Entries</em>}'. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @return the meta object for the containment reference list
	 *         '<em>Entries</em>'.
	 * @see de.tudresden.slr.model.bibtex.BibtexFile#getEntries()
	 * @see #getBibtexFile()
	 * @generated
	 */
	 ...
	 * @see de.tudresden.slr.model.bibtex.BibtexFile#getPath()
	 * @see #getBibtexFile()
	 * @generated
	 */
	EAttribute getBibtexFile_Path();
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Authors</b></em>' attribute list
		...
		/**
		 * The meta object literal for the '<em><b>Unparsed Authors</b></em>' attribute
		 * feature. <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		...
		/**
		 * The meta object literal for the '<em><b>Cites</b></em>' attribute feature.
		 * <!-- begin-user-doc --> <!-- end-user-doc -->
		 * 
		 * @generated
		 */
		 ...
		 * @generated
		 */
		EAttribute DOCUMENT__LINE = eINSTANCE.getDocument_Line();
		 ...
		 * @generated
		 */
		EClass BIBTEX_FILE = eINSTANCE.getBibtexFile();
		 ...
		 * @generated
		 */
		EReference BIBTEX_FILE__ENTRIES = eINSTANCE.getBibtexFile_Entries();
		 ...
		 * @generated
		 */
		EAttribute BIBTEX_FILE__PATH = eINSTANCE.getBibtexFile_Path();
