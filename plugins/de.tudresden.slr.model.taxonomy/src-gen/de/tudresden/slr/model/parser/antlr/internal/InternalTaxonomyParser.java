...
public class InternalTaxonomyParser extends AbstractInternalAntlrParser {
        ...
        try {
            ...
            switch (alt4) {
                case 1 :
                    ...
                    {
                    otherlv_1=(Token)match(input,11,FOLLOW_11_in_ruleTerm236); 
                    	...
                    	case 1 :
                    	    ...
                    	    switch (alt2) {
                    	        case 1 :
                    	            ...
                    	            {
                    	            otherlv_3=(Token)match(input,12,FOLLOW_12_in_ruleTerm271); 
                    ...
                    otherlv_4=(Token)match(input,13,FOLLOW_13_in_ruleTerm287); 
    ...
    public static final BitSet FOLLOW_RULE_ID_in_ruleTerm218 = new BitSet(new long[]{0x0000000000000802L});
    public static final BitSet FOLLOW_11_in_ruleTerm236 = new BitSet(new long[]{0x0000000000003010L});
    public static final BitSet FOLLOW_ruleTerm_in_ruleTerm258 = new BitSet(new long[]{0x0000000000003010L});
    public static final BitSet FOLLOW_12_in_ruleTerm271 = new BitSet(new long[]{0x0000000000003010L});
    public static final BitSet FOLLOW_13_in_ruleTerm287 = new BitSet(new long[]{0x0000000000000002L});
