 ...
 * <ul>
 * <li>{@link de.tudresden.slr.model.taxonomy.impl.TermImpl#getName <em>Name
 * </em>}</li>
 * <li>{@link de.tudresden.slr.model.taxonomy.impl.TermImpl#getSubclasses <em>
 * Subclasses</em>}</li>
 * <li>{@link de.tudresden.slr.model.taxonomy.impl.TermImpl#getUuid <em>Uuid
 * </em>}</li>
 * </ul>
 * </p>
 *
...
public class TermImpl extends MinimalEObjectImpl.Container implements Term {
	...
	/**
	 * The cached value of the '{@link #getSubclasses() <em>Subclasses</em>}'
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaxonomyPackage.TERM__NAME, oldName, name));
	}
	...
	public EList<Term> getSubclasses() {
		if (subclasses == null) {
			subclasses = new EObjectContainmentEList<Term>(Term.class, this,
					TaxonomyPackage.TERM__SUBCLASSES);
		}
		return subclasses;
	}
	...
	public void setUuid(UUID newUuid) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					TaxonomyPackage.TERM__UUID, oldUuid, uuid));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		...
		case TaxonomyPackage.TERM__UUID:
			return getUuid();
		}
