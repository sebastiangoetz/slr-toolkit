...
public class InternalTaxonomyLexer extends Lexer {
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTaxonomy.g:174:17: ( '//' )
            // InternalTaxonomy.g:174:19: '//'
            {
            match("//"); 
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTaxonomy.g:176:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalTaxonomy.g:176:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalTaxonomy.g:176:24: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_WS() throws RecognitionException {
        try {
            int _type = RULE_WS;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTaxonomy.g:178:9: ( ( ' ' | '\\t' )+ )
            // InternalTaxonomy.g:178:11: ( ' ' | '\\t' )+
            {
            // InternalTaxonomy.g:178:11: ( ' ' | '\\t' )+
            int cnt2=0;
            loop2:
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTaxonomy.g:180:14: ( ( '\\r' )? '\\n' )
            // InternalTaxonomy.g:180:16: ( '\\r' )? '\\n'
            {
            // InternalTaxonomy.g:180:16: ( '\\r' )?
            int alt3=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTaxonomy.g:182:9: ( ( 'A' .. 'Z' | 'a' .. 'z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '-' | '0' .. '9' | ' ' )* )
            // InternalTaxonomy.g:182:11: ( 'A' .. 'Z' | 'a' .. 'z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '-' | '0' .. '9' | ' ' )*
            {
            ...
            // InternalTaxonomy.g:182:31: ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '-' | '0' .. '9' | ' ' )*
            loop4:
            do {
                int alt4=2;
    ...
    static final String[] DFA5_transitionS = {
            "\1\5\1\6\2\uffff\1\6\22\uffff\1\5\13\uffff\1\2\2\uffff\1\4\21\uffff\32\7\6\uffff\32\7\1\1\1\uffff\1\3",
            "",
            "",
            "",
            "\1\11\4\uffff\1\10",
