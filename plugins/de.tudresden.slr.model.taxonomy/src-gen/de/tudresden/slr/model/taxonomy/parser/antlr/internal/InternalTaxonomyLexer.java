...
public class InternalTaxonomyLexer extends Lexer {
    ...
    public final void mRULE_SL_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTaxonomy.g:214:17: ( '//' )
            // InternalTaxonomy.g:214:19: '//'
            {
            match("//"); 
    ...
    public final void mRULE_ML_COMMENT() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTaxonomy.g:216:17: ( '/*' ( options {greedy=false; } : . )* '*/' )
            // InternalTaxonomy.g:216:19: '/*' ( options {greedy=false; } : . )* '*/'
            {
            match("/*"); 

            // InternalTaxonomy.g:216:24: ( options {greedy=false; } : . )*
            loop1:
            do {
                int alt1=2;
    ...
    public final void mRULE_NEWLINE() throws RecognitionException {
        try {
            ...
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTaxonomy.g:220:14: ( ( '\\r' )? '\\n' )
            // InternalTaxonomy.g:220:16: ( '\\r' )? '\\n'
            {
            // InternalTaxonomy.g:220:16: ( '\\r' )?
            int alt3=2;
    ...
    public final void mRULE_ID() throws RecognitionException {
        try {
            int _type = RULE_ID;
            int _channel = DEFAULT_TOKEN_CHANNEL;
            // InternalTaxonomy.g:222:9: ( ( 'A' .. 'Z' | 'a' .. 'z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '-' | '0' .. '9' | ' ' )* )
            // InternalTaxonomy.g:222:11: ( 'A' .. 'Z' | 'a' .. 'z' ) ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '-' | '0' .. '9' | ' ' )*
            {
            ...
            // InternalTaxonomy.g:222:31: ( 'A' .. 'Z' | 'a' .. 'z' | '_' | '-' | '0' .. '9' | ' ' )*
            loop4:
            do {
                int alt4=2;
