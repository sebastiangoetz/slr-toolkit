...
public class TaxonomyPackageImpl extends EPackageImpl implements TaxonomyPackage
{
  ...
  /**
	 ...
	 * @generated
	 */
	private EDataType euuidEDataType = null;
   ...
   * <!-- end-user-doc -->
	 * @generated
	 */
  public EReference getTerm_Subclasses()
  {
  ...
  /**
	 ...
	 * @generated
	 */
	public EAttribute getTerm_Uuid() {
	 ...
	 * @generated
	 */
	public EDataType getEUUID() {
		return euuidEDataType;
	}
  ...
  public void createPackageContents()
  {
		...
		createEReference(termEClass, TERM__SUBCLASSES);
		createEAttribute(termEClass, TERM__UUID);

		// Create data types
		euuidEDataType = createEDataType(EUUID);
	}
  ...
  public void initializePackageContents()
  {
		...
		initEReference(getTerm_Subclasses(), this.getTerm(), null, "subclasses", null, 0, -1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTerm_Uuid(), this.getEUUID(), "uuid", "", 1, 1, Term.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		// Initialize data types
		initEDataType(euuidEDataType, UUID.class, "EUUID", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
